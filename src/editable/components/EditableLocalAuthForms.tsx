...
const inputClass =
  'ig-input bg-white/88 text-base font-bold text-[var(--slot4-page-text)] placeholder:text-[var(--slot4-soft-muted-text)]'
const buttonClass =
  'inline-flex h-12 items-center justify-center rounded-[1.1rem] bg-[var(--slot4-page-text)] px-6 text-[11px] font-extrabold uppercase tracking-[0.18em] text-[var(--slot4-dark-text)] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
